...
install_dependencies_deb() {
    ...
    DEBIAN_FRONTEND=noninteractive apt-get install -y wget tar gcc automake autoconf libtool make curl git unzip sudo libreadline-dev lsb-release gawk lua5.1 lua5.1-dev
}
